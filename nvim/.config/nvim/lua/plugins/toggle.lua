return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>cx", ":set opfunc=v:lua.toggle_checkbox<CR>g@", { silent = true })
    vim.keymap.set("x", "<leader>cx", ":<C-U>:lua toggle_checkbox('visual')<CR>", { silent = true })
    vim.keymap.set("n", "<leader>cxx", "<leader>x_", { remap = true })
  end,
}
